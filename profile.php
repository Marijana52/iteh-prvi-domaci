...
<?php elseif ($gyms != null) : ?>
    ...
    <div class="container">
        <h2 class="center">Gyms you've submited</h2>
        <div class="row">
                ...
                <div class="col s12 m6 l4 xl3">
                    <div class="card z-depth-0 radius-card">
                        ...
                        <div class="card-action right-align radius-card">
                            <a href="gym.php?id=<?php echo $gym['id']; ?>" class="grey-text text-darken-2">
                                More Info
                            </a>
                        </div>
                    </div>
...
<?php else : ?>
    ...
    <div class="center">
        <a href="add.php" class="btn center grey darken-2">Add one</a>
    </div>
